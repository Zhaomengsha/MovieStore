...
namespace BetaMovieStore.Controllers
{
    public class MovieController : Controller
    {
        ...
        public ActionResult newestMovies()
        {
            ...
            var query = db.Movies.OrderByDescending(m => m.ReleaseYear).ThenBy(m => m.Title).Take(5).ToList();
        ...
        public ActionResult oldestMovies()
        {
            ...
            var query = db.Movies.OrderBy(m => m.ReleaseYear).ThenBy(m => m.Title).Take(5).ToList();
        ...
        public ActionResult cheapestMovies()
        {
            ...
            var query = db.Movies.OrderBy(m => m.Price).ThenBy(m => m.Title).Take(5).ToList();
